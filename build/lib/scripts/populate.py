...
def populate_patient(patient_name):
    ...
    print('Collecting matching NSP data chunks...')
    NSPChunks().populate(restriction, suppress_errors=True, display_progress=True)

    print('Searching for task comments...')
    TaskComments().populate(restriction, suppress_errors=True, display_progress=True)
    StartComments().populate(restriction, suppress_errors=True, display_progress=True)
    TaskIDComments().populate(restriction,suppress_errors=True,  display_progress=True)
    StopComments().populate(restriction, suppress_errors=True, display_progress=True)

    print('Stitching new data...')
    StitchedChunks().populate(restriction, suppress_errors=True, display_progress=True)
